...
for account in "${accounts[@]}"; do
  ...
  printf '%s\n' \
    ...
    'If an owner, date, or time is missing, use the safe wording "I will confirm internally and reply as soon as I have accurate information" without any deadline, weekday, placeholder, title, or person name.' \
